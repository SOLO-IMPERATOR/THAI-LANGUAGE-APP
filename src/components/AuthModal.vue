    ...
    >
      <div class="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-slate-200 text-slate-800">
        ...
        <div class="text-xs text-slate-600 space-y-2 max-h-60 overflow-y-auto pr-1 leading-relaxed">
          ...
          <p>
            2. Цели обработки: предоставление доступа к тренажеру «Тайлинго», сохранение прогресса интервальных повторений (SRS), участие в рейтинге и коммуникация в разговорных комнатах.
          </p>
          <p>
...
const headerTitle = computed(() => {
  if (mode.value === 'login') return 'Вход в Тайлинго';
